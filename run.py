...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Transformer & CNN family for Time Series Forecasting')
    ...
    parser.add_argument('--model', type=str, default='TFIRNet',
                        help='model name, options: [Autoformer, PatchMixer, TSMixer]')
